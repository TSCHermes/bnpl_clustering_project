...
def main():
    ...
    # Fit preprocessor on training data to get the feature names
    preprocessor.fit(X_train)
    
    # Get feature names
    cat_onehot = preprocessor.named_transformers_['cat']
    # The categorical transformer is a Pipeline: imputer -> onehot
    ...
    feat_imp_path = data_path / 'docs' / 'OLIST_FEATURE_IMPORTANCES.csv'
    ...
    plt.tight_layout()
    fi_plot_path = data_path / 'results' / 'visuals' / 'olist_feature_importances.png'
    ...
    metrics_path = data_path / 'docs' / 'OLIST_BEST_MODEL_METRICS.json'
    ...
    roc_path = data_path / 'docs' / 'OLIST_ROC_CURVE_DATA.csv'
