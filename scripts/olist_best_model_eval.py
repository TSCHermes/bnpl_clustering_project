...
def main():
    ...
    print(f"Gradient Boosting + Feature Set C")
    print(f"AUC-ROC: {auc_roc:.4f}")
    print(f"AUC-PR:  {auc_pr:.4f}")
    
    # Save results
    results_path = data_path / 'docs' / 'OLIST_BEST_MODEL_METRICS.txt'
    with open(results_path, 'w') as f:
        f.write(f"Model: Gradient Boosting\\n")
        f.write(f"Feature Set: C (RFM + behavioral + geographic)\\n")
