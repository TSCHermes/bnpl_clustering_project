...
def evaluate_model(model, X_train, X_test, y_train, y_test, model_name, feature_set):
    ...
    # Identify column types after selection (need to recompute from X_train)
...
def main():
    ...
    for fs in feature_sets:
        ...
        X, y, _, _, _ = prepare_features(df, feature_set=fs)
        ...
        for model_name, model in models.items():
            ...
            res = evaluate_model(model, X_train, X_test, y_train, y_test, model_name, fs)
            results.append(res)
